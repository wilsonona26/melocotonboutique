      ...
      <section className="gradient-hero py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left animate-fade-in">
            <span className="badge badge-primary text-sm mb-4 inline-flex">✨ Nueva Colección 2025</span>
            <h1 className="font-display font-bold text-5xl sm:text-6xl text-gray-900 leading-tight mb-4">
              Tu moda,<br />
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative">
              <div className="w-72 h-72 lg:w-96 lg:h-96 rounded-full bg-primary-200/40 flex items-center justify-center">
                <span className="text-[10rem]">🍑</span>
              </div>
              <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-lg p-4 animate-fade-in">
                <p className="text-xs text-gray-500">Nuevos productos</p>
                <p className="font-bold text-primary-600 text-lg">Cada semana ✨</p>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-lg p-4 animate-fade-in">
                <p className="text-xs text-gray-500">Envíos a todo</p>
                <p className="font-bold text-primary-600 text-lg">Ecuador 🇪🇨</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {CATEGORIES.map(cat => (
              <Link
                ...
                className="group flex flex-col items-center gap-3 p-6 bg-secondary-50 hover:bg-primary-50 rounded-2xl transition-all duration-200 hover:-translate-y-1"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="gradient-primary rounded-3xl p-12 text-white">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-primary-600 font-bold px-8 py-3 rounded-xl hover:bg-gray-50 transition-colors"
            >
